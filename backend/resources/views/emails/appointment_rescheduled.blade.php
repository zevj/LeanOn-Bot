...
<head>
    ...
    <title>Appointment Rescheduled — LeanOn Bot</title>
</head>
                ...
                <table width="100%" style="max-width:580px; background:#ffffff; border-radius:16px; overflow:hidden; box-shadow: 0 4px 24px rgba(0,0,0,0.08);">
                                ...
                                <tr>
                                    <td align="center">
                                        ...
                                        <p style="margin:8px 0 0; color:rgba(255,255,255,0.85); font-size:14px; line-height:1.5;">
                                            An update from the Guidance &amp; Wellness Team
                                        </p>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td style="padding: 28px 40px 8px;">
                            ...
                            <p style="margin:0 0 16px; color:#374151; font-size:15px; line-height:1.7;">
                                Please be informed that your counseling appointment with the Gordon College Guidance Office has been rescheduled by the administrator.
                            </p>
                            <p style="margin:0 0 16px; color:#374151; font-size:15px; line-height:1.7;">
                                We want to make sure you have the support you need. Please review the updated details below:
                            </p>
                        </td>
                    </tr>
                                ...
                                <tr>
                                    <td style="padding:16px 20px;">
                                        ...
                                        <p style="margin:6px 0 0; color:#6b7280; font-size:13px; line-height:1.5;">
                                            Please make sure to attend this session. If you need to request a different time, please contact the Guidance Office.
                                        </p>
                                    </td>
                                </tr>
                            </table>
